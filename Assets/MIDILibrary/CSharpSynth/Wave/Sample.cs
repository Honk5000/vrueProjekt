...
{
	/// <summary>
	/// A sample, representing soundwave amplitude data at a specific point in time.
	/// </summary>
    public class Sample
    {
        ...
        //--Public Methods
		/// <summary>
		/// Initializes a new <see cref="CSharpSynth.Wave.Sample"/> object and reads in the Wav file provided.
		/// </summary>
