                        ...
                        case "<":
                            ...
                            else if (line.StartsWith("<region>"))
                            {
                                ...
                                /*while (text[x] != "")
                                {
                                    ...
                                    if (x >= text.Length)
                                        break;*/
							string[] keyValuePairStrings = text[x].Substring("<region>".Length).Trim().Split(new string[] { " " }, StringSplitOptions.RemoveEmptyEntries);
							foreach(string kvpString in keyValuePairStrings) {
								string[] Rvalue = kvpString.Split(new string[] {"="}, StringSplitOptions.RemoveEmptyEntries);
							...
							//string[] Rvalue = text[x].Substring("<region>".Length).Trim().Split(new string[] { "=" }, StringSplitOptions.RemoveEmptyEntries);
